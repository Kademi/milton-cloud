...
public class VersioningOutputStream extends  OutputStream{
    ...
    private static final Logger log = LoggerFactory.getLogger(VersioningOutputStream.class);
    ...
    public VersioningOutputStream(ChunkWriter chunkWriter, int chunkSize) {
