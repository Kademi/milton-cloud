...
public class RootContext extends Context implements Closeable {
    ...
    public RootContext(FactoryCatalog factoryCatalog, List<Object> initialContents) {
        if( factoryCatalog == null ) throw new IllegalArgumentException("factoryCatalog cannot be null");
    ...
    Registration getOrCreateRegistration(Class c, Context context) {
        ...
        if( reg == null ) throw new NullPointerException("factory " + f.getClass().getName() + " returned null reg");
        return reg;
    }
    ...
    /**
     * This weird little guy is to allow us to set this root context into
     * a locator which was defined in spring config before this one.
     * @param loc
     */
