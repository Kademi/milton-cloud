...
//                    Also, add Repository access screen to website
    ...
    private void createDefaultWebsiteContent(Branch websiteBranch, Profile user, Session session) {
        try {
            ...
            html += "</head>\n";
            html += "<body>\n";
            html += "<h2>Welcome to your new site!</h2>\n";
            html += "<p>Login with the menu in the navigation above, then you will be able to start editing using the edit page buttons to the right</p>\n";
            html += "</body>\n";
            html += "</html>\n";
